...
const ListadoComentarios = ({idPub}) => {
    const comentarios = [
        ...
        {id: 2, autor: 'Bryan', contenido: 'Elegir Colores', fecha: "15/09/2021"},
        {id: 2, autor: 'Bryan', contenido: 'Elegir Plataformas de Pago', fecha: "02/08/2021"},
        {id: 1, autor: 'Danny', contenido: 'Elegir Hosting',  fecha: "02/02/2021"}
    ];
